...
WRITE_TMP = False # write tmp files
...
METABOLISM_PATH = PurePath(asset_path, "metabolic_networks","metabolism.v4.20Mar2023.pkl") # path to metabolism object pickle
...
## Not used for random fold ordering
