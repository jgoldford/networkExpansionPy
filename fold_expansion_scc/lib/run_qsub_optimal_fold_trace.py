...
# Give job a name
#$ -N fold_expansion_optimal_trace
...
python_call = '/projectnb2/bioinfor/SEGRE/goldford/network_expansion/networkExpansionPy/fold_expansion_scc/lib/optimal_fold_trace.py'
...
sh_file = qsub_dir + '/foldExpansion.OptimalTrace.09Feb2021.qsub'
